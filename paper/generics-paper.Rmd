...
model_prefix <- "results-habituals-S1-ffPrior2HyperStructured-silenceAlt-"
...
m.hab.somemodel.endorsement <- fread(
  paste(project.path,"models/habituals/results/", 
        "results-habituals-S1-ffPrior2HyperStructured-silenceAlt-",
        sep = "")
  ) %>% mutate(chain = 1) %>%
  filter(type == 'predictive') %>%
