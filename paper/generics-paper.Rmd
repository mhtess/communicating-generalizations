...
# l0.model <- '
# var nullParams = {a : 1, b: 20};
# var mixture = data.mix[0];
# var priorParams = data.params[0];
# 
# var literalListener = Infer({
#   model: function(){
#     var state = flip(mixture) ? beta(priorParams) : beta(nullParams)
#     var state_0 = flip(mixture) ? beta(priorParams) : beta(nullParams)
#     var state_05 = flip(mixture) ? beta(priorParams) : beta(nullParams)
#     var statePrior = flip(mixture) ? beta(priorParams) : beta(nullParams)
#     var theta = uniform(0,1)
#     condition(state > theta)
#     condition(state_0 > 0)
#     condition(state_05 > 0.5)
#     return {
#       state_PosteriorGeneralization: state, 
#       state_Posterior0: state_0, 
#       state_Posterior05: state_05, 
