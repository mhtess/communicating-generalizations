...
Generalizations about categories (i.e., *generic language*) have received substantial interest of psychologists for their role in concept formation [@Gelman2004] and in stereotype propogation [@Rhodes2012].
...
Empirical work done on category generalizations hs elucidated another troubling phenomenon.
...
In this final set of experiments, we show how our communicative theory of generalizations in language explains the flexibility in endorsement of familiar generic statements (Expt. 8).
In Experiment 9, we replicate and extend a paradigm used by @Cimpian2010 to demonstrate the asymmetry between endorsements and interpretations nad find that a similar pattern is predicted by our model.
...
## Experiment 8: Endorsing Generic Language
...
To compare the model to empirical truth judgments, we first measure the prior distribution over prevalence of these properties (Expt. 8a) in a way analagous to how we measured the prior for events (Experiment 1).
In Expt. 8b, we collect human judgements about the acceptability of the generic sentences. 

### Experiment 8a: Measuring the Prevalence Prior for Categories
...
### Experiment 8b: Endorsing Generic Language
