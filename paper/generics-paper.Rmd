...
"Lays eggs" is somewhat diagnostic for birds, but there are many kinds of birds, and the feature is not itself diagnostic for "Robins". 
The enriched alternative model also falls short for "Mosquitos don't carry malaria".
Negative properties (like, "not carrying malaria") is completely undiagnostic for every category, and this model ends up believing "Mosquitos don't carry malaria" is a relatively good statement becuase of the high prevalence (i.e., most mosquitos don't arry malaria).
...
## Experiment 9: The Asymmetry between Endorsement and Interpretation of Generic Language (replication and extension of Cimpian et al., 2010)
...
Measuring \emph{a priori} beliefs is subtle when the kinds are unknown.
...
### Experiment 9a: Prevalence Priors for Unfamiliar Kinds
...
### Experiment 9b: Interpreting Novel Generic Statements
...
### Experiment 9c: The Asymmetry Between Truth Conditions and Interpretations
...
## Experiment 1: Eliciting the Frequency Prior for Events
...
## Experiment 2: Endorsing Habitual Language
...
## Experiment 3: Interpreting Habitual Language
...
The materials in this experiment are the same as used in Expts. 1 & 2.
...
## Experiment 4: Communicating predictive propensities

In Experiment 2, we supplied participants with a statement about how often a person has done the action in the past and asked them to judge the correspoding habitual statement.
...
### Experiment 4a: Prediction elicitation
...
### Experiment 4b: Felicity judgments
...
## Experiment 5: Manipulating the Prevalence Prior for Causes
...
## Experiment 6: Endorsing Causal Language
...
## Experiment 7: Interpreting Causal Language
