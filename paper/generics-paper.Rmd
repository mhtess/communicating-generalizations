...
## The Comparison Class, Question Under Discussion, and Focus

In this paper, we proposed a model for understanding generic language that relies upon interlocutors' shared beliefs over the statistics of the property to accurately arrive at generic interpretation identical to that of human participants. 
...
In this way, the statement of genericity is addressing the implicit Question Under Discussion: *who does F?*, *what makes F?*, or *what has F*?


taking is a distribution over kinds (and their associated prevalence of the property).
