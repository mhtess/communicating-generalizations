...
$$
\text{what is the math to show here?} \\
...
This paper puts forth the theory that the simplest language of abstractions (i.e., the languag eof generalizations) communicates predictive probabilities from speaker to hearer. 
This might seem to contradict a basic tenet in cognitive psychology, that human cognition falters when reasoning about probabilities [@Tversky1974].
