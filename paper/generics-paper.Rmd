...
Generalizations are among the easiest forms of compositional linguistic expression.
They appear everywhere in human conversation, pedagogy (*Blickets make the machine go.*), political and scientific discourse (*The President peddles falsehoods.*, *Psychology experiments don’t replicate.*), stereotypes [*Boys are good at math*; @GelmanEtAl2004; @Rhodes2012], motivation [*Big girls eat broccoli!*; @Cimpian2010motivation], emotion-regulation  (*Accidents happen.*), child-directed (*Mommy works late*) and child-produced speech [*Slides aren't for grown-ups!*; @Gelman2008], and many other facets of experience.
...
Intuition tells us that generalizations in language convey something about the propensity of an instance, property, or event, but exactly what is unclear.
...
Well, *Birds lay eggs* even though only about half of them do (females).
Half of birds are also female, and yet *Birds are female* sounds like a strange thing to say.
*Mosquitos carry malaria* is a true statement despite the prevalence of carrying malaria among mosquitos being a just a fraction of 1\%, while *Canadians are right-handed* is also weird, even though the vast majority of them are. 
...
This question has been investigated by psychologists, linguists, and philosophers since @Carlson1977, and has had the narrow focus of generalizations about *categories*, so-called *generic language*.
Here, we provide a unified theory of all generalizations conveyed in language.
We test out theory on 3 case studies: generalizations about categories, events, and causal forces.
...
In Section 2, we conduct a set of experiments to test the *truth conditions* of familiar generalizations about cagegories (generic statements), and find our model predicts key patterns in human judgments
