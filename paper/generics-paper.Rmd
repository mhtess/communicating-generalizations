...
Leraning that one event consistently tends to result in another event serves the fondation building an intuitive theory of causailty.
...
Participants read told that they are an astronaut-scientist on a distant planet trying to figure out how some system works (e.g., how to make a certain kind of animal more alert). They are told:
...
Participants are assigned to one of three conditions: (a) prior / manipulation check; (b) endorsement; or (c) interpretation. 
...
We do not assume that the frequencies that are shown in the experiment are directly encoded as participants' prior.
...
A second dimension of manipulation 
...
The experiment is a single trial.
