var bins = [0, 0.01,0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45,
...
var avoidEnds = function(response){
	return response === 0 ? eps : response === 1 ?  1 - eps : response
}

var avoidUpperBound = function(response){
	return response===1 ? 1-eps : response
}

var alignPrevalence = function(number){
	return avoidEnds(round(number))
};
